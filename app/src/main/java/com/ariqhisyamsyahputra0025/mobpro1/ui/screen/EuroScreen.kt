...
@Composable
fun EuroScreenPreview() {
    Mobpro1Theme {
        EuroScreen(rememberNavController())
    }
}
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun EuroScreen(navController: NavHostController) {
    Scaffold(
        topBar = {
            TopAppBar(
        ...
        EuroContent(Modifier.padding(innerPadding),
            navController = navController
        )
    }
}
@Composable
fun EuroContent(modifier: Modifier = Modifier, navController: NavHostController) {
    ...
    val optUsdToIdr = stringResource(id = R.string.eur_ke_idr)
    val optIdrToUsd = stringResource(id = R.string.idr_ke_eur)
    ...
    val exchangeRateEurToIdr = 20039f
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.kurs_euro),
            ...
            Button(
                onClick = {
                    ...
                    resultValue = when (selectedOption) {
                        optUsdToIdr -> amount * exchangeRateEurToIdr
                        optIdrToUsd -> amount / exchangeRateEurToIdr
                        else -> 0f
                    }
                },
