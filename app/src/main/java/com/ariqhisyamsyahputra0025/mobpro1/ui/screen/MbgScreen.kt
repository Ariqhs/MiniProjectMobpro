...
@Composable
fun MbgScreenPreview() {
    Mobpro1Theme {
        MbgScreen(rememberNavController())
    }
}
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun MbgScreen(navController: NavHostController) {
    Scaffold(
        topBar = {
            TopAppBar(
        ...
        MbgContent(Modifier.padding(innerPadding),
            navController = navController
        )
    }
}
@Composable
fun MbgContent(modifier: Modifier = Modifier, navController: NavHostController) {
    ...
    val optUsdToIdr = stringResource(id = R.string.mbg_ke_idr)
    val optIdrToUsd = stringResource(id = R.string.idr_ke_mbg)
    ...
    val exchangeRateMbgToIdr = 15000f
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.kurs_mbg),
            ...
            Button(
                onClick = {
                    ...
                    resultValue = when (selectedOption) {
                        optUsdToIdr -> amount * exchangeRateMbgToIdr
                        optIdrToUsd -> amount / exchangeRateMbgToIdr
                        else -> 0f
                    }
                },
