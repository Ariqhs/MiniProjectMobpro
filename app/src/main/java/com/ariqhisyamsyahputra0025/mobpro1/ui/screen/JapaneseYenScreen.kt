...
@Composable
fun JapaneseYenScreenPreview() {
    Mobpro1Theme {
        JapaneseYenScreen(rememberNavController())
    }
}
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun JapaneseYenScreen(navController: NavHostController) {
    Scaffold(
        topBar = {
            TopAppBar(
        ...
        JapaneseYenContent(Modifier.padding(innerPadding),
            navController = navController
        )
    }
}
@Composable
fun JapaneseYenContent(modifier: Modifier = Modifier, navController: NavHostController) {
    ...
    val optUsdToIdr = stringResource(id = R.string.jpy_ke_idr)
    val optIdrToUsd = stringResource(id = R.string.idr_ke_jpy)
    ...
    val exchangeRateJpyToIdr = 107.28f
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.kurs_yen),
            ...
            Button(
                onClick = {
                    ...
                    resultValue = when (selectedOption) {
                        optUsdToIdr -> amount * exchangeRateJpyToIdr
                        optIdrToUsd -> amount / exchangeRateJpyToIdr
                        else -> 0f
                    }
                },
